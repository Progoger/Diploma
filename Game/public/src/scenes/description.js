...
export default class Description extends Phaser.Scene{
    ...
    preload() {
        this.load.image('bg1', `src/assets/descriptions/${stat.active_level}1.png`);
        this.load.image('bg2', `src/assets/descriptions/${stat.active_level}2.png`);
        this.load.image('bg3', `src/assets/descriptions/${stat.active_level}3.png`);
