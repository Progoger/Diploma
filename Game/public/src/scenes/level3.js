...
export default class Level3 extends Phaser.Scene {
    ...
    create() {
        ...
        var borrow = this.add.sprite(innerWidth/2.2-cell.width, innerHeight*0.58, 'bomb').setScale(0.17*stat.koeff, 0.17*stat.koeff).setInteractive();
        var save = this.add.sprite(innerWidth/2.2, innerHeight*0.58, 'moneybox').setScale(0.17*stat.koeff, 0.17*stat.koeff).setInteractive();
    ...
    createWindow(type, description){
        ...
        if (description === 'end'){
            ...
            if (this.players_borrow === 3000 && this.players_saving+this.players_money < number){
                ...
                var comp = this.add.sprite(innerWidth*0.96, innerHeight*0.93, 'complete_l3').setScale(0.08*stat.koeff, 0.08*stat.koeff).setInteractive().setTint(0x800000);
