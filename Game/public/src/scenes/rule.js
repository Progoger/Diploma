...
export default class Rule extends Phaser.Scene{
    ...
    create(data) {
        ...
        this.add.image(bg.x+bg.width*0.72*0.5, bg.y+bg.height*0.72*0.54, data.sc+'_'+this.active).setScale(0.55, 0.55).setInteractive();
        this.add.image(bg.x+bg.width*0.72*0.06, bg.y+bg.height*0.72*0.53, 'left').setScale(0.09, 0.09).setInteractive();
        this.add.image(bg.x+bg.width*0.72*0.94, bg.y+bg.height*0.72*0.53, 'right').setScale(0.09, 0.09).setInteractive();
